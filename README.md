...
Atualmente trabalho com desenvolvimento BackEnd em **TypeScript**, buscando evoluir em arquitetura de software, qualidade de código e soluções escaláveis.

## Sobre mim

- Tenho interesse em **BackEnd, Java, Node.js e TypeScript**
- Atuo com desenvolvimento de **APIs, serviços, automações e integrações**
- Tenho experiência com sistemas que envolvem **CRM, atendimento, WhatsApp, dashboards, relatórios e filas**
- Busco evoluir constantemente como **Desenvolvedor BackEnd**
